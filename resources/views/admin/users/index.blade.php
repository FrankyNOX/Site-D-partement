	        ...
	        <table id="tbl" class="table data-tables table-striped table-hover" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Email</th>
                        <th>Role</th>
                        <th class='bool text-center'>Actif</th>
                        <th class="no-sort"></th>
                    </tr>
                </thead>
                ...
                <tbody>
        					@foreach ($items as $item)
          						...
          						<tr>
                          <td><a href="{{ route(ADMIN . '.users.edit', $item->id) }}">{{ $item->firstname }}</a></td>
                                    <td><a href="{{ route(ADMIN . '.users.edit', $item->id) }}">{{ $item->lastname }}</a></td>
                          <td>{{ $item->email }}</td>
