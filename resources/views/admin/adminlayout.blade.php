    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url(ADMIN . '/') }}" class="logo">
                ...
                <span class="logo-lg"><b>GINFO </b>GTIC/G2I</span>
            </a>
                                ...
                                <li class="user-footer" style="height:75px;padding-top:20px;">
                                    ...
                                    <div class="pull-right">
                                        {!! Form::open(['url'=>'logout']) !!}
                                            <button type="submit" class="btn btn-danger btn-flat"  style="width:100px">Se deconnecter</button>
                                        {!! Form::close() !!}
                                    </div>
                                </li>
                            </ul>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                  ...
                  <div class="pull-left info">
                    ...
                    <p>
                      <small ><a href="{{ route('logout', auth()->id()) }}"><i class="fa fa-sign-out"></i> <span>Se deconnecter</span></a></small>
                    </p>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">NOX Company</a>.</strong> Tous les droits sont réservés.
        </footer>
